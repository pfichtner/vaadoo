 ...
 * the negative cases.
 */
class JdkOnlyCodeFragmentPBTest extends ConstraintArbitraries {

	FixtureFactory fixtureFactory = new FixtureFactory(new JdkOnlyCodeFragment(), NullValueException.class);
